...
public class ParticipanteRest {
	...
	public ResponseEntity<?> buscarEmailDeParticipante(@RequestParam String email)
	{
		Participante participanteRetornado = participanteRespository.buscarParticipantePorEmail(email);
